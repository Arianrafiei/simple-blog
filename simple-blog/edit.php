...
?>
    ...
    <div class="w3-card-4">
        ...
        <div class="w3-container w3-teal">
            ...
            <h4 class="w3-container"><a href="<?=$permalink?>">مشاهده پست</a> </h4>
        ...
        <form action="" method="POST" class="w3-container">
            ...
            <p>
                <input type="submit" class="w3-btn w3-teal w3-round" name="upd" value="ذخیره">
            </p>

            <p>
            <div class="w3-text-red">
                <a href="<?=$url_path?>del.php?id=<?php echo $row['id']; ?>"
                   onclick="return confirm('Are you sure you want to delete this post?'); ">حذف</a></div>
            </p>
        </form>
    </div>
    </div>
